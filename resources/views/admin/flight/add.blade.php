                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="post" action="{{route('flight.store')}}" id="demo-form" data-parsley-validate>
                                @csrf

                                <label for="code_flight">Mã Chuyến Bay *:</label>
                                <input type="text" id="code_flight" class="form-control" name="code_flight" required />
