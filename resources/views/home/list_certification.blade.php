...
<section class="breadcrumb-section pt-0">
    ...
    <div class="breadcrumb-content">
        <div>
            <h2>Thông Tin Chứng Nhận</h2>
            <nav aria-label="breadcrumb" class="theme-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('list.certification')}}">Xem Toàn Bộ Thông Tin Chứng Nhận Tại Đây</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="category-sec ratio3_2 section-b-space">
    <div class="container">
        <div class="title-1 title-5">
            <span class="title-label">Chứng Nhận</span>
            <h2>Chứng Nhận Bay</h2>
        </div>
        <div class="row">
            <div class="col">
                <div class="slide-3 arrow-classic">
                    @foreach($list_certification as $value)
                        <a href="#">
                            <div class="category-box wow fadeInUp">
                                <div class="img-category">
                                    <div class="side-effect"></div>
                                    <div>
                                        <img src="https://images.unsplash.com/photo-1570610159825-ec5d3823660c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1333&q=80" alt=""
                                             class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                </div>
                                <div class="content-category">
                                    <div class="top">
                                        <h3>Chứng Nhận Bay</h3>
                                    </div>
                                    <p>Ngày Tạo: {{date('d/m/Y', strtotime($value->created_at))}}</p>
                                    <h6>Mã Phi Công: {{$value->ma_phi_cong}} | <span>Mã Phi Cơ: {{$value->ma_phi_co}}</span></h6>
                                </div>
                            </div>
                        </a>
                    @endforeach
