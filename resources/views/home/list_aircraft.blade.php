...
<section class="breadcrumb-section pt-0">
    ...
    <div class="breadcrumb-content">
        <div>
            <h2>Danh Sách Các Phi Cơ</h2>
            <nav aria-label="breadcrumb" class="theme-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Xem Danh Sách Các Phi Cơ Tại Đây</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<!-- category 4 start -->
<section class="section-b-space dark-cls category-bg">
    <img src="assets/frontend/images/cab/grey-bg.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
    <div class="container">
        <div class="title-1">
            <span class="title-label">Phi Cơ</span>
            <h2>Danh Sách Phi Cơ</h2>
        </div>
        <div class="row">
            <div class="col">
                <div class="slider-4 arrow-classic">
                    @foreach($list_aircraft as $value)
                        <div>
                            <div class="category-block">
                                <div class="category-img">
                                    <img src="https://images.unsplash.com/photo-1562805612-9c340007e0b9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt=""
                                         class="img-fluid blur-up lazyload " style="border-radius: 25px">
                                </div>
                                <h6><span>{{number_format($value->kc_bay)}} km/h</span></h6>
                                <h4>{{$value->ma_phi_co}}</h4>
                                <h5>{{$value->ten_phi_co}}</h5>
                            </div>
                        </div>
                    @endforeach
                </div>
